    ...
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="border-b bg-card p-4 shadow-sm">
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Pet Health Consultation Assistant</p>
            {petInfo && (
        ...
        {messages.length === 0 ? (
          <div className="h-full flex items-center justify-center text-center">
            <div className="space-y-4">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-2">Welcome to Dr. Max</h2>
                <p className="text-muted-foreground">
                  I am a professional pet doctor who can help you understand your pet's health concerns.
                  <br />
                  Please start by asking questions about your pet's health.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex justify-start">
                <div className="bg-secondary text-secondary-foreground px-4 py-2 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Dr. Max is thinking...</span>
                  </div>
                </div>
              </div>
            )}
                ...
                <Card className="bg-red-50 border-red-200 p-3 flex items-start gap-2 max-w-sm">
                  ...
                  <div className="text-sm text-red-700">
                    ...
                    <p className="text-xs mt-1">
                      {error instanceof Error ? error.message : "Unable to connect to Dr. Max"}
                    </p>
                  </div>
                </Card>
              </div>
      ...
      <div className="border-t bg-card p-4 shadow-lg">
        ...
        <p className="text-xs text-muted-foreground mt-2 text-center">
          Dr. Max can only answer questions related to pet health
        </p>
      </div>
    </div>
  );
